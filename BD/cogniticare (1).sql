...
--
-- Servidor: localhost
-- Tiempo de generación: 22-11-2024 a las 17:32:34
...
--
ALTER TABLE `info_p`
  MODIFY `id_infop` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `preguntas`
--
ALTER TABLE `preguntas`
  MODIFY `id_quest` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT de la tabla `pregunta_respuesta`
--
ALTER TABLE `pregunta_respuesta`
  MODIFY `id_pregunta_respuesta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=276;

--
-- AUTO_INCREMENT de la tabla `pruebas`
--
ALTER TABLE `pruebas`
  MODIFY `id_p` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `pruebas_realizadas`
--
ALTER TABLE `pruebas_realizadas`
  MODIFY `id_registro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT de la tabla `respuestas`
--
ALTER TABLE `respuestas`
  MODIFY `id_resp` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `respuestas_usuario`
--
ALTER TABLE `respuestas_usuario`
  MODIFY `id_registro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_us` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `info_p`
  ADD CONSTRAINT `info_p_us` FOREIGN KEY (`id_us`) REFERENCES `usuarios` (`id_us`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Filtros para la tabla `preguntas`
--
ALTER TABLE `preguntas`
  ADD CONSTRAINT `pruebaid` FOREIGN KEY (`id_p`) REFERENCES `pruebas` (`id_p`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Filtros para la tabla `pregunta_respuesta`
--
ALTER TABLE `pregunta_respuesta`
  ADD CONSTRAINT `preguntaid` FOREIGN KEY (`id_quest`) REFERENCES `preguntas` (`id_quest`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `respuestaid` FOREIGN KEY (`id_resp`) REFERENCES `respuestas` (`id_resp`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Filtros para la tabla `pruebas_realizadas`
--
ALTER TABLE `pruebas_realizadas`
  ADD CONSTRAINT `id_respuestasFK` FOREIGN KEY (`id_respuestas`) REFERENCES `respuestas_usuario` (`id_registro`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
